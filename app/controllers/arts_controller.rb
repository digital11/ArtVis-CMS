class ArtsController < ApplicationController
  ...
  def new
    ...
    @art = Art.new
    @art.artist = @artist
    @mediums = Medium.find_all_by_account_id(current_user.account.id)

    @styles = Style.find_all_by_account_id(current_user.account.id)
  ...
  def create
    ...
    @art.account = current_user.account
    respond_to do |format|
      if @art.save
